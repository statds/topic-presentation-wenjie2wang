...
pkgs <- c("DT", "dygraphs", "htmltools", "leaflet", "plotly", "shiny")
need.packages(pkgs)
...
slides_url <- "https://statds.github.io/topic-presentation-wenjie2wang/"
repo_url <- "https://github.com/statds/topic-presentation-wenjie2wang/"
...
- R packages needed for following examples:
  ...
  install.packages(c("DT", "dygraphs", "leaflet",
                     "plotly", "shiny", "shinythemes"))
  ```
...
server <- function(input, output, session) {
    ...
    ## in the mtcars dataset by a input cylinder
    dataInput <- reactive({
